    ...
    <body>
        ...
        <div class="page-container">
            ...
            <form action="<?php echo U('dologin','');?>" method="post" style="text-align:left;">
                ...
                <input type="text" name="vcode" class="username" placeholder="请输入验证码" style="width:150px;"><img src="<?php echo U('Admin/Index/verify','','');?>" style="margin-left:10px;margin-bottom:-15px;" onclick="show(this)" />
